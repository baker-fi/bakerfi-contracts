...
export interface AaveV3PoolMockInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "_borrowedToken",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface AaveV3PoolMock extends BaseContract {
  connect(runner?: ContractRunner | null): AaveV3PoolMock;
  ...
  _borrowedToken: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "_borrowedToken"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
