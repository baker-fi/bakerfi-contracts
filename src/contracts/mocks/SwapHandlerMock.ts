...
export interface SwapHandlerMockInterface extends Interface {
...
export interface SwapHandlerMock extends BaseContract {
  connect(runner?: ContractRunner | null): SwapHandlerMock;
  waitForDeployment(): Promise<this>;

  interface: SwapHandlerMockInterface;
