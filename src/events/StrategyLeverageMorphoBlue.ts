export interface GovernshipTransferredEvent { returnValues: {'previousGovernor': string;'newGovernor': string;} }
export interface InitializedEvent { returnValues: {'version': number;} }
export interface LoanToValueChangedEvent { returnValues: {'value': number;} }
export interface MaxLoanToValueChangedEvent { returnValues: {'value': number;} }
export interface MaxSlippageChangedEvent { returnValues: {'value': number;} }
