...
export interface TimelockControllerInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [AddressLike, BigNumberish, BytesLike, BytesLike, BytesLike, BigNumberish],
  ): string;
  encodeFunctionData(
...
export interface TimelockController extends BaseContract {
  ...
  updateDelay: TypedContractMethod<[newDelay: BigNumberish], [void], 'nonpayable'>;
  ...
  getFunction(nameOrSignature: 'TIMELOCK_ADMIN_ROLE'): TypedContractMethod<[], [string], 'view'>;
  getFunction(
