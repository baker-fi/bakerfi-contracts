...
export class ChainLinkOracle__factory extends ContractFactory {
  ...
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(priceFeed, minPrice, maxPrice, overrides || {});
  }
  override deploy(
    priceFeed: AddressLike,
    minPrice: BigNumberish,
    ...
    return super.deploy(priceFeed, minPrice, maxPrice, overrides || {}) as Promise<
      ChainLinkOracle & {
  ...
  static connect(address: string, runner?: ContractRunner | null): ChainLinkOracle {
