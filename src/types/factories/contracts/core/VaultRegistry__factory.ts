...
import type { VaultRegistry, VaultRegistryInterface } from '../../../contracts/core/VaultRegistry';
...
export class VaultRegistry__factory extends ContractFactory {
  ...
  override deploy(ownerToSet: AddressLike, overrides?: NonPayableOverrides & { from?: string }) {
  ...
  static connect(address: string, runner?: ContractRunner | null): VaultRegistry {
