...
export class StrategyLeverageSettings__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): StrategyLeverageSettings__factory {
  ...
  static connect(address: string, runner?: ContractRunner | null): StrategyLeverageSettings {
    return new Contract(address, _abi, runner) as unknown as StrategyLeverageSettings;
  }
}
