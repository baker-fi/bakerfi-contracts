...
export class StrategyLeverageSettingsMock__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): StrategyLeverageSettingsMock__factory {
  ...
  static connect(address: string, runner?: ContractRunner | null): StrategyLeverageSettingsMock {
    return new Contract(address, _abi, runner) as unknown as StrategyLeverageSettingsMock;
  }
}
