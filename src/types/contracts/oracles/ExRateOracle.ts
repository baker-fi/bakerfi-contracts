...
export interface ExRateOracleInterface extends Interface {
  getFunction(
...
export interface ExRateOracle extends BaseContract {
  connect(runner?: ContractRunner | null): ExRateOracle;
  waitForDeployment(): Promise<this>;

  interface: ExRateOracleInterface;
