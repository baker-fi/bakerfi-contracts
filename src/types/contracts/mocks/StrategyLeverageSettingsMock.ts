...
export interface StrategyLeverageSettingsMock extends BaseContract {
  connect(runner?: ContractRunner | null): StrategyLeverageSettingsMock;
  waitForDeployment(): Promise<this>;

  interface: StrategyLeverageSettingsMockInterface;
