...
export interface AccountTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface AccountToken extends BaseContract {
  connect(runner?: ContractRunner | null): AccountToken;
