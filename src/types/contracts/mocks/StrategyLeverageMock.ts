...
export interface StrategyLeverageMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "asset"
      | "deploy"
...
export interface StrategyLeverageMock extends BaseContract {
  connect(runner?: ContractRunner | null): StrategyLeverageMock;
  waitForDeployment(): Promise<this>;

  interface: StrategyLeverageMockInterface;
