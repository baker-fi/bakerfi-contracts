...
export interface BakerFiProxyAdminInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'changeProxyAdmin'
      | 'getProxyAdmin'
...
export interface BakerFiProxyAdmin extends BaseContract {
  connect(runner?: ContractRunner | null): BakerFiProxyAdmin;
  waitForDeployment(): Promise<this>;

  interface: BakerFiProxyAdminInterface;
  ...
  getProxyImplementation: TypedContractMethod<[proxy: AddressLike], [string], 'view'>;
  ...
  ): TypedContractMethod<[proxy: AddressLike, newAdmin: AddressLike], [void], 'nonpayable'>;
  getFunction(
  ...
  ): TypedContractMethod<[proxy: AddressLike, implementation: AddressLike], [void], 'nonpayable'>;
  getFunction(
