...
export interface StrategyUniV3SwapAndInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'asset'
      | 'deploy'
...
export interface StrategyUniV3SwapAnd extends BaseContract {
  connect(runner?: ContractRunner | null): StrategyUniV3SwapAnd;
  waitForDeployment(): Promise<this>;

  interface: StrategyUniV3SwapAndInterface;
  ...
  getFunction(nameOrSignature: 'feeTier'): TypedContractMethod<[], [bigint], 'view'>;
  ...
  getFunction(nameOrSignature: 'uniRouter'): TypedContractMethod<[], [string], 'view'>;
