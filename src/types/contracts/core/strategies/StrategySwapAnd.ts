...
export interface StrategySwapAndInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'asset'
      | 'deploy'
...
export interface StrategySwapAnd extends BaseContract {
  connect(runner?: ContractRunner | null): StrategySwapAnd;
  waitForDeployment(): Promise<this>;

  interface: StrategySwapAndInterface;
