...
export interface StrategyAeroSwapAndInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "aeroRouter"
      | "asset"
...
export interface StrategyAeroSwapAnd extends BaseContract {
  connect(runner?: ContractRunner | null): StrategyAeroSwapAnd;
  waitForDeployment(): Promise<this>;

  interface: StrategyAeroSwapAndInterface;
