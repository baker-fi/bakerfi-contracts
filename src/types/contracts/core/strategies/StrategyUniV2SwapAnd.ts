...
export interface StrategyUniV2SwapAndInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "asset"
      | "deploy"
...
export interface StrategyUniV2SwapAnd extends BaseContract {
  connect(runner?: ContractRunner | null): StrategyUniV2SwapAnd;
  waitForDeployment(): Promise<this>;

  interface: StrategyUniV2SwapAndInterface;
