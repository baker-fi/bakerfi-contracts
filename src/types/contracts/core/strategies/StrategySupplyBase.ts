...
export interface StrategySupplyBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "asset"
      | "deploy"
...
export interface StrategySupplyBase extends BaseContract {
  connect(runner?: ContractRunner | null): StrategySupplyBase;
  waitForDeployment(): Promise<this>;

  interface: StrategySupplyBaseInterface;
