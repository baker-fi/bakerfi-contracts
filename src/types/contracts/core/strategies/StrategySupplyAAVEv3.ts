...
export interface StrategySupplyAAVEv3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | 'asset'
      | 'deploy'
...
export interface StrategySupplyAAVEv3 extends BaseContract {
  connect(runner?: ContractRunner | null): StrategySupplyAAVEv3;
  waitForDeployment(): Promise<this>;

  interface: StrategySupplyAAVEv3Interface;
