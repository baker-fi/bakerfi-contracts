...
export interface StrategySupplyERC4626 extends BaseContract {
  connect(runner?: ContractRunner | null): StrategySupplyERC4626;
  waitForDeployment(): Promise<this>;

  interface: StrategySupplyERC4626Interface;
