...
export declare namespace StrategyLeverageMorphoBlue {
  export type StrategyLeverageMorphoParamsStruct = {
    collateralToken: AddressLike;
    debtToken: AddressLike;
    oracle: AddressLike;
    flashLender: AddressLike;
    morphoBlue: AddressLike;
    morphoOracle: AddressLike;
    irm: AddressLike;
    lltv: BigNumberish;
  };

  export type StrategyLeverageMorphoParamsStructOutput = [
...
export interface StrategyLeverageMorphoBlueInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "asset"
      | "deploy"
  ...
  encodeFunctionData(
    ...
    values: [
      AddressLike,
      AddressLike,
      StrategyLeverageMorphoBlue.StrategyLeverageMorphoParamsStruct
    ]
  ): string;
  encodeFunctionData(
...
export interface StrategyLeverageMorphoBlue extends BaseContract {
  connect(runner?: ContractRunner | null): StrategyLeverageMorphoBlue;
  waitForDeployment(): Promise<this>;

  interface: StrategyLeverageMorphoBlueInterface;
  ...
  initialize: TypedContractMethod<
    [
      ...
      params: StrategyLeverageMorphoBlue.StrategyLeverageMorphoParamsStruct
    ],
    [void],
    "nonpayable"
  >;
