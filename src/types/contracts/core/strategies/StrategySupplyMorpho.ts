...
export interface StrategySupplyMorphoInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'asset'
      | 'deploy'
...
export interface StrategySupplyMorpho extends BaseContract {
  connect(runner?: ContractRunner | null): StrategySupplyMorpho;
  waitForDeployment(): Promise<this>;

  interface: StrategySupplyMorphoInterface;
