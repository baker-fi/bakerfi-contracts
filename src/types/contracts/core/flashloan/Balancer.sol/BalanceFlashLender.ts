...
export interface BalanceFlashLenderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CALLBACK_SUCCESS"
      | "flashFee"
...
export interface BalanceFlashLender extends BaseContract {
  connect(runner?: ContractRunner | null): BalanceFlashLender;
  waitForDeployment(): Promise<this>;

  interface: BalanceFlashLenderInterface;
