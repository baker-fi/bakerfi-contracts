...
export interface ICLSwapCallbackInterface extends Interface {
...
export interface ICLSwapCallback extends BaseContract {
  connect(runner?: ContractRunner | null): ICLSwapCallback;
  waitForDeployment(): Promise<this>;

  interface: ICLSwapCallbackInterface;
